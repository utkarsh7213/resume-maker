        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 bg-white">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 first-letter:uppercase break-all">
                ...
                <div className="w-full lg:w-8/12 ">
                    <img className="w-full h-full rounded-xl" src="/2150041853.jpg" alt="A group of People" />
                </div>
            </div>
